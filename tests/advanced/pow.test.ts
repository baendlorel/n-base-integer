...
describe('NBaseInteger.pow', () => {
  ...
  it('should work for base 16', () => {
    const a = NBaseInteger(0xf, 16); // 15
    const b = NBaseInteger(2, 16);
  ...
  it('should support pow(number) and pow(NBaseInteger) equivalence', () => {
    ...
    expect(a.pow(3).toString()).toBe(a.pow(NBaseInteger(3, 10)).toString());
