...
describe('NBaseInteger 链式四则混合运算', () => {
  ...
  it('链式混合正负数', () => {
    const a = NBaseInteger(20, 10);
    const b = NBaseInteger(-5, 10);
  ...
  it('链式除法和取余', () => {
    const a = NBaseInteger(1234, 10);
    const b = NBaseInteger(100, 10);
